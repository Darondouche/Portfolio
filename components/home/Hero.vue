        ...
        <div class="max-w-2xl">
          <div class="w-full mb-8">
            <a aria-label="Home" class="block w-16 h-16 origin-left pointer-events-auto" href="/">
              <img alt="" sizes="4rem" src="~/assets/avatar.jpg" class="object-cover rounded-full h-18">
            </a>
          </div>
  
          <h1 class="text-4xl font-bold tracking-tight text-zinc-100 sm:text-5xl">
            Hi! I'm Alice, a student in Ada Tech School whom is looking for an apprenticeship !
          </h1>
          <p class="mt-6 text-base text-zinc-400">
            My name is Alice, I'm from Nantes and I'm in a tech school to become a full stack developper!
          </p>
          <div class="flex gap-6 mt-6">
            ...
            <a class="p-1 -m-1 group" aria-label="Follow on GitHub" href="https://github.com">
              <svg viewBox="0 0 24 24" aria-hidden="true"
                class="w-6 h-6 transition fill-zinc-400 group-hover:fill-zinc-300">
            ...
            <a class="p-1 -m-1 group" aria-label="Follow on LinkedIn" href="https://linkedin.com">
              <svg viewBox="0 0 24 24" aria-hidden="true"
                class="w-6 h-6 transition fill-zinc-400 group-hover:fill-zinc-300">
                <path
